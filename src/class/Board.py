...
class Board:
    ...
    def Draw(self, canvas, canvasW, canvasH):
        ...
        for y in range(0, self.height):
            canvas.create_line(0, y * self.cellsHeight,
                               canvasW, y * self.cellsHeight)

        for x in range(0, self.width):
            canvas.create_line(x * self.cellsWidth, 0, x *
                               self.cellsWidth, canvasH)
        ...
        for x in range(0, self.height):
            for y in range(0, self.width):
                ...
                canvas.create_rectangle(y * self.cellsWidth, x * self.cellsHeight, y * self.cellsWidth +
